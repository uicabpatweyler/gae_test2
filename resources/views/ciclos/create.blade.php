  ...
  <div class="col-10 col-md-10 mt-2 pb-3 rounded shadow bg-white border">
    ...
    <div class="d-flex align-items-center justify-content-between p-2 my-2 rounded shadow-sm border">
      <h5 class="mb-0 lh-100 text-uppercase">
        <i class="fas fa-plus-circle text-info"></i> nuevo ciclo
      </h5>
    ...
    <form action="{{route('ciclos.store')}}" method="POST" id="form_ciclo" name="form_ciclo">
      ...
      <div class="form-row">
        <div class="form-group col-md-2">
          ...
          <input type="text" class="form-control form-control-sm" id="periodo" name="periodo" placeholder="0000-0000" required>
        </div>
      </div>
