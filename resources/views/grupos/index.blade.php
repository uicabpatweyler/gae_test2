  ...
  <div class="col-12 col-md-12 mt-2 pb-3 rounded shadow bg-white border">
    ...
    <div class="d-flex align-items-center justify-content-between p-2 my-2 rounded shadow-sm border">
      <h5 class="mb-0 lh-100 text-uppercase">
        <i class="fas fa-table text-info"></i> grupos escolares
      </h5>
      <a href="{{ route('grupos.create') }}" class="btn btn-sm blue600 text-white text-uppercase"  role="button" aria-pressed="true" >
    ...
    <div class="card border-0">
      <div class="form-row align-items-center">
        ...
        <div class="col-sm-2 my-1">
          <label class="sr-only" for="escuela_id">Grado</label>
          <select id="grado_id" name="grado_id" class="form-control" required disabled="">
  ...
  <script>
    ...
    function filtrarGrupos(){
      $('#grupos').DataTable({
        ...
        searching: false,
        destroy: true,
        ajax: urlRoot + '/data/grupos/' + escuela + '/' + grado + '/' + ciclo,
        language: {
