  ...
  <div class="col-12 col-md-12 mt-2 pb-3 rounded shadow bg-white border">
    ...
    <div class="d-flex align-items-center justify-content-between p-2 my-2 rounded shadow-sm border">
      <h5 class="mb-0 lh-100 text-uppercase">
        <i class="fas fa-pencil-alt text-info"></i> editar categoría
      </h5>
    ...
    <!-- Formulario -->
    <form action="{{route('categorias.update',$categoria->id)}}" method="POST" id="form_categoria" name="form_categoria">
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control form-control-sm" value="{{$categoria->nombre}}" id="nombre" name="nombre" style="text-transform: capitalize;" required>
        </div>
      </div>
