...
@section('title', 'Imprimir Recibo de Inscripción')
  ...
  <div class="col-12 col-md-12 mt-2 pb-3 rounded shadow bg-white border">
    ...
    <div class="d-flex align-items-center justify-content-between p-2 my-2 rounded shadow-sm border">
      <h5 class="mb-0 lh-100 text-uppercase">
        <i class="fas fa-print text-info"></i> Impresión Recibo de Inscripción
      </h5>
      ...
      function filtrarDatos(urlAjax){
        $('#alumnos').DataTable({
          ...
          columns: [
            ...
            {data: "pago_id", name: "pago_id", className:"text-center font-weight-bold"},
            {data: "receipt_enroll", className:"text-center", searchable: false,
              render: function(data){
                return htmlDecode(data);
              }
            }
