...
@section('title', 'Recibo/Reporte de Ventas')
  ...
  <div class="col-12 col-md-12 mt-2 pb-3 rounded shadow bg-white border">
    ...
    <div class="d-flex align-items-center justify-content-between p-2 my-2 rounded shadow-sm border">
      <h5 class="mb-0 lh-100 text-uppercase">
        <i class="fas fa-table text-info"></i> Recibo/Reporte de Ventas
      </h5>
  ...
  <script>
    $(document).ready(function(){
      ...
      $("#btn_buscar").click(function(){
        if($("#fecha").val()!==""){
          filtrarDatos(urlRoot + '/data/ventas/porfecha/'+$("#fecha").val());
        }
      });

      $("#btn_reporte").click(function(){
        if($("#fecha").val()!==""){
          window.open(urlRoot + '/reportes/ventaspordia/'+$("#fecha").val(), '_blank');
          return false;
        }
      });
      ...
      function filtrarDatos(urlAjax){
        dtAlumnos = $('#alumnos').DataTable({
          ...
          columns: [
            ...
            {data: 'nombre1', name: 'nombre1', searchable: false},
            {data: 'nombre2', name: 'nombre2', searchable: false},
            {data: 'apellido1', name: 'apellido1', searchable: false},
            {data: 'apellido2', name: 'apellido2', searchable: false},
            {data: "recibo_venta", className:"text-center", searchable: false,
              render: function(data){
