  ...
  <div class="col-12 col-md-12 mt-2 pb-3 rounded shadow bg-white border">
    ...
    <div class="d-flex align-items-center justify-content-between p-2 my-2 rounded shadow-sm border">
      <h5 class="mb-0 lh-100 text-uppercase">
        <i class="fas fa-plus-circle text-info"></i> Editar información
      </h5>
      <a href="{{ URL::previous() }}" class="btn btn-sm blue600 text-white text-uppercase"  role="button" aria-pressed="true" >
  ...
  <script>
    ...
    $().ready(function() {
      ...
      function saveUpdate(){
        ...
        $.ajax({
          method: "POST",
          url: $("#form_editinfo").attr('action'),
          data: $("#form_editinfo").serialize()
        })
