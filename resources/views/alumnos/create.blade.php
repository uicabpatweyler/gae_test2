  ...
  <div class="col-md-12 col-sm-12 mt-2 pb-3 rounded shadow bg-white border">
    ...
    <div class="d-flex align-items-center justify-content-between p-2 my-2 rounded shadow-sm border">
      <h5 class="mb-0 lh-100 text-uppercase">
        <i class="fas fa-plus-circle text-info"></i> Inscripción de Alumno
      </h5>
    ...
    <!-- Formulario -->
    <form method="POST" action="" name="form_alumno" id="form_alumno">
      <div class="form-row">
    ...
    $().ready(function() {
      ...
      $("#curp").inputmask("A{4} 9{6} A{1} A{2} A{3} (99)|(AA)|(9A)|(A9)", {
        onKeyValidation: function (key, result) {
          if (!result) {
            $("#curp").addClass("is-invalid").removeClass("is-valid");
          }
        },
      ...
      $('#fechanacimiento').inputmask('9999-99-99',{
        onincomplete : function(){
