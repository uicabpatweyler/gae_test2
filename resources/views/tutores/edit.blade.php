  ...
  <div class="col-md-12 col-sm-12 mt-2 pb-3 rounded shadow bg-white border">
    ...
    <div class="d-flex align-items-center justify-content-between p-2 my-2 rounded shadow-sm border">
      <h5 class="mb-0 lh-100 text-uppercase">
        <i class="fas fa-plus-circle text-info"></i> Editar Tutor
      </h5>
    </div>
    <!-- Titulo de la seccion -->
    ...
    <!-- Formulario -->
    <form method="POST" action="{{route('tutores.update', $tutor->id)}}" name="form_tutor" id="form_tutor">
      ...
      <div class="form-row">
        <div class="form-group col-md-3">
          ...
          <input type="text" class="form-control form-control-sm" id="nombre" name="nombre" placeholder="Nombre" value="{{$tutor->nombre}}" style="text-transform:capitalize" required>
        </div>
        <div class="form-group col-md-3">
          <label for="apellido1">Apellido Paterno <span class="text-danger">*</span> </label>
          <input type="text" class="form-control form-control-sm" id="apellido1" name="apellido1" placeholder="Apellido Paterno" value="{{$tutor->apellido1}}" style="text-transform:capitalize" required>
        </div>
        <div class="form-group col-md-3">
          <label for="apellido2">Apellido Materno</label>
          <input type="text" class="form-control form-control-sm" id="apellido2" name="apellido2" placeholder="Apellido Materno" value="{{$tutor->apellido2}}" style="text-transform:capitalize">
        </div>
        <div class="form-group col-md-3">
          ...
          <select name="genero" id="genero" class="form-control form-control-sm" required>
            ...
            <option value="H" {{$tutor->genero==='H' ? "selected" : ""}}>Hombre</option>
            <option value="M" {{$tutor->genero==='M' ? "selected" : ""}}>Mujer</option>
          </select>
        </div>
      </div>
...
@push('scripts')
  ...
  <script>
    ...
    $('#btn_cancelar').click(function(){
      ...
      showCancel('{{ route('tutores.show', $tutor->id) }}')
    });
